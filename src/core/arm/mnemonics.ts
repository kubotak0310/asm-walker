...
export const FULL_NAMES: Record<string, string> = {
  ...
  LDM: 'LOAD MULTIPLE', LDMIA: 'LOAD MULTIPLE INCREMENT AFTER', LDMFD: 'LOAD MULTIPLE FULL DESCENDING',
  STM: 'STORE MULTIPLE', STMIA: 'STORE MULTIPLE INCREMENT AFTER', STMEA: 'STORE MULTIPLE EMPTY ASCENDING',
...
export const SYNTAX: Record<string, string> = {
  ...
  LDM: 'LDM Rn, {reglist}', LDMIA: 'LDMIA Rn!, {reglist}', LDMFD: 'LDMFD Rn!, {reglist}',
  STM: 'STM Rn, {reglist}', STMIA: 'STMIA Rn!, {reglist}', STMEA: 'STMEA Rn!, {reglist}',
