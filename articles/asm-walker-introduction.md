---
title: "C言語がアセンブラに変わる瞬間を、1命令ずつ目で追える学習ツールを作った"
emoji: "⚙️"
type: "idea"
...
もしかしたら、AI がさらに進化して、人間がコードを書く必要すらなくなる未来が来るかもしれない。
...
関数がネストするほど、スタックフレームが積み上がる様子を色分けで確認できる。
